...
/**
 * _itoa - converts a given integer to array
 * @n: the given number
 *
...
/**
 * write_history - prints the error
...
/**
 * _atoi - converts a given character to integer
...
/**
 * intlen - Determine number of digits in an integer
